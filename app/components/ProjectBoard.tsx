        ...
        <table className="min-w-[600px] w-full text-xs sm:text-sm">
          <thead className="bg-gray-900 text-gray-50">
            <tr>
              ...
              <th className="px-2 sm:px-3 py-2 text-left font-medium">Status</th>
              <th className="px-2 sm:px-3 py-2 text-left font-medium">Deadline</th>
              <th className="px-2 sm:px-3 py-2 text-left font-medium">Assigned</th>
              <th className="px-2 sm:px-3 py-2 text-left font-medium">Budget</th>
              <th className="px-2 sm:px-3 py-2 text-right font-medium"></th>
            </tr>
          </thead>
                ...
                <td className="px-2 sm:px-3 py-2 text-right">
                  <div className="flex flex-row gap-1.5 sm:opacity-20 sm:group-hover:opacity-100 transition-opacity">
                    <button onClick={() => onEdit(project)}
                      className="text-white bg-blue-700 hover:bg-blue-600 shadow-xs font-medium rounded text-xs px-2 py-1 transition-colors whitespace-nowrap" >
                      Edit
                    </button>
                    <button onClick={() => onDelete(project.id)} className="text-white bg-red-700 hover:bg-red-800 shadow-xs font-medium rounded text-xs px-2 py-1 transition-colors whitespace-nowrap">
                      Delete
                    </button>
                  </div>
                </td>
